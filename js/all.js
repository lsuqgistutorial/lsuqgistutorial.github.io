...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Title","Getting Started","Working with Vectors","QGIS Download ","QGIS Installation Process","QGIS Window - What is in there?","Adding Google Maps Backgroud Layer","GNSS Data","Download Options ","Read and Agree with QGIS Licesne Agreement ","Destination Folder Selection","QGIS Installation Components","Installation Final Window","Browser Panel Not Showing Fix","Set New Connection","XYZ Connection window","Importing GNSS Data to QGIS","GNSS Data Imported to QGIS"," Removing Layers","Exporting Layers"," menu bar","Project Toolbar toolbar","Digitizing Toolbar toolbar","Advanced Digitizing Toolbar toolbar","Map Navigation Toolbar toolbar","Attributes Toolbar toolbar","Plugins Toolbar toolbar","Help Toolbar toolbar","Raster Toolbar toolbar","Label Toolbar toolbar","Vector Toolbar toolbar","Web Toolbar toolbar","Snapping Toolbar toolbar","Data Source Manager Toolbar toolbar","Selection Toolbar toolbar"," toolbar"," toolbar"," toolbar","FeatureGridCreator toolbar","Project","Edit","Open From","Open Recent","Save To","Import/Export","Select","Add Circle"],
    DREX_NODE_LINKS: ["index.htm","getting_started.htm","working_with_vectors.htm","qgis_download_.htm","qgis_installation_process.htm","qgis_window___what_is_in_there_.htm","adding_google_maps_backgroud_layer.htm","gnss_data.htm","download_options_.htm","read_and_agree_with_qgis_licesne_agreement_.htm","destination_folder_selection.htm","qgis_installation_components.htm","installation_final_window.htm","browser_panel_not_showing_fix.htm","set_new_connection.htm","xyz_connection_window.htm","importing_gnss_data_to_qgis.htm","gnss_data_imported_to_qgis.htm","_removing_layers.htm","exporting_layers.htm","_menu_bar.htm","project_toolbar_toolbar.htm","digitizing_toolbar_toolbar.htm","advanced_digitizing_toolbar_toolbar.htm","map_navigation_toolbar_toolbar.htm","attributes_toolbar_toolbar.htm","plugins_toolbar_toolbar.htm","help_toolbar_toolbar.htm","raster_toolbar_toolbar.htm","label_toolbar_toolbar.htm","vector_toolbar_toolbar.htm","web_toolbar_toolbar.htm","snapping_toolbar_toolbar.htm","data_source_manager_toolbar_toolbar.htm","selection_toolbar_toolbar.htm","_toolbar_1.htm","_toolbar_2.htm","_toolbar_3.htm","featuregridcreator_toolbar.htm","project.htm","edit.htm","open_from.htm","open_recent.htm","save_to.htm","import_export.htm","select.htm","add_circle.htm"],
    DREX_NODE_CHILD_START: [1,3,7,8,9,13,13,16,17,17,17,17,17,17,17,17,17,20,39,39,39,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,45,47,47,47,47,47,47],
    DREX_NODE_CHILD_END: [3,7,8,9,13,13,16,17,17,17,17,17,17,17,17,17,20,39,39,39,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,45,47,47,47,47,47,47,47],
    DREX_MENU_TYPE: 2,
